...
export default function Home() {
  return (
    <div className="min-h-screen bg-white font-['Inter']">
        ...
        <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center min-h-[80vh]">
          ...
          <div className="space-y-10">
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <a href="#contact" className="group relative inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-[#0066FF] to-[#1A00E2] text-white font-semibold rounded-full hover:shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 transform hover:-translate-y-1">
              ...
              <a href="tel:+902128757983" className="group inline-flex items-center gap-4 px-8 py-4 bg-white border-2 border-[#1A00E2] text-[#1A00E2] font-semibold rounded-full hover:bg-[#1A00E2] hover:text-white transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl">
      ...
      <section id="services" className="py-20 px-4 lg:px-20 bg-gray-50 relative">
        <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg relative hover:shadow-xl transition-shadow">
              <div className="h-64 relative">
                <Image
                  ...
                  className="object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-br from-[#007BFF]/80 to-[#0056B3]/80"></div>
          ...
          <Image
                  ...
                  className="object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-br from-[#28A745]/80 to-[#1E7E34]/80"></div>
                <div className="absolute top-4 right-4 w-16 h-16 bg-white rounded-full shadow-lg flex items-center justify-center">
          ...
          <Image
                  ...
                  className="object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-br from-[#FFC107]/80 to-[#E0A800]/80"></div>
                <div className="absolute top-4 right-4 w-16 h-16 bg-white rounded-full shadow-lg flex items-center justify-center">
      ...
      <section id="about" className="py-20 px-4 lg:px-20 bg-[#F8F9FA] relative">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="w-full h-96 bg-gradient-to-br from-[#007BFF] to-[#0056B3] rounded-3xl flex items-center justify-center">
                <div className="text-white text-lg">Şirket Görseli</div>
              </div>
              <div className="absolute inset-0 flex items-center justify-center">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="relative h-64 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300">
                <div className="absolute bottom-4 left-4 text-white">
                  <h3 className="font-semibold">İhracat Konteyner</h3>
            ...
            <div className="relative h-64 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300">
                <div className="absolute bottom-4 left-4 text-white">
                  <h3 className="font-semibold">İthalat Konteyner</h3>
            ...
            <div className="relative h-64 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300">
                <div className="absolute bottom-4 left-4 text-white">
                  <h3 className="font-semibold">Ağır Yük Taşımacılığı</h3>
            ...
            <div className="relative h-64 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300">
                <div className="absolute bottom-4 left-4 text-white">
                  <h3 className="font-semibold">Gümrükleme İşlemleri</h3>
            ...
            <div className="relative h-64 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300">
                <div className="absolute bottom-4 left-4 text-white">
                  <h3 className="font-semibold">Proje Taşımacılığı</h3>
          ...
          <Image
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300">
                <div className="absolute bottom-4 left-4 text-white">
                  <h3 className="font-semibold">Liman Hizmetleri</h3>
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 lg:px-20 bg-gradient-to-r from-[#007BFF] to-[#0056B3] relative overflow-hidden">
        <div className="absolute inset-0">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          <h2 className="text-4xl lg:text-[50px] font-semibold text-white mb-8 leading-[55px] tracking-[-1px]">
            Harekete geçmeye hazır mısınız? Hemen teklif alın.
          </h2>
          <a href="#contact" className="bg-[#FFC107] text-[#007BFF] px-8 py-4 rounded-lg font-semibold hover:bg-[#E0A800] transition-colors">
            Teklif Al
          </a>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <form className="space-y-6">
                <div>
                  <label className="block text-sm font-medium text-[#0E0E0E] mb-2">Ad Soyad</label>
                  <input type="text" className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#007BFF] focus:border-transparent" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-[#0E0E0E] mb-2">E-posta</label>
                  <input type="email" className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#007BFF] focus:border-transparent" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-[#0E0E0E] mb-2">Telefon</label>
                  <input type="tel" className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#007BFF] focus:border-transparent" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-[#0E0E0E] mb-2">Mesaj</label>
                  <textarea rows={4} className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#007BFF] focus:border-transparent"></textarea>
                </div>
                <button type="submit" className="w-full bg-[#007BFF] text-white py-3 rounded-lg font-semibold hover:bg-[#0056B3] transition-colors">
                  Mesaj Gönder
                </button>
              </form>
            </div>
          ...
          <div className="grid lg:grid-cols-4 gap-8">
            <div className="lg:col-span-2">
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="text-xl font-bold">ÇNR Lojistik</span>
              </div>
      ...
      {/* Mobile Menu Overlay */}
      <div className="md:hidden fixed inset-0 bg-black bg-opacity-50 z-40 hidden" id="mobile-menu-overlay">
